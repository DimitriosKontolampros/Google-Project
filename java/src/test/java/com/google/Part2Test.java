...
//if(Integer.parseInt(scanner.nextLine())<=search_videos.size()){
//    String Title=search_videos.get(Integer.parseInt(scanner.nextLine())).substring(4,search_videos.get(Integer.parseInt(scanner.nextLine())).indexOf("("));
//    for(Video video_ : videoLibrary.getVideos()){
//      if(video_.getTitle().equals(Title)){
//        playing_video=video;
